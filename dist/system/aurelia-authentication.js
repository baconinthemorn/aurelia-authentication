    ...
    execute: function () {
      ...
      _export('Popup', Popup = function () {
        ...
        Popup.prototype.pollPopup = function pollPopup() {
          ...
          return new Promise(function (resolve, reject) {
            _this3.polling = PLATFORM.global.setInterval(function () {
              ...
              try {
                ...
                if (loginHost === PLATFORM.global.document.location.host) {
                ...
                } else if (_this3.popupWindow.location.host === PLATFORM.global.document.location.host && (_this3.popupWindow.location.search || _this3.popupWindow.location.hash)) {
                  ...
                  _this3.popupWindow.close();
                  PLATFORM.global.clearInterval(_this3.polling);
                }
              } catch (error) {
                errorData = error;
              }
        ...
        function AuthService(authentication, config, bindingSignaler, eventAggregator) {
          ...
          this.storageEventHandler = function (event) {
            ...
            if (_this9.config.storageChangedRedirect) {
              PLATFORM.location.href = _this9.config.storageChangedRedirect;
            }
            ...
            this.client.post(this.config.joinBase(this.config.refreshTokenUrl ? this.config.refreshTokenUrl : this.config.loginUrl), content, this.config.getOptionsForTokenRequests()).then(function (response) {
              ...
              if (_this12.getAccessToken()) {
                ...
                if (_this12.config.expiredRedirect) {
                  PLATFORM.location.assign(_this12.config.expiredRedirect);
                }
